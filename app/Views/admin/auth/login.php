    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body login-card-body">
                ...
                <p class="text-center">Or already have an account?<a href="register.html"
                        class="btn btn-link text-center p-0 ms-1">LOG IN</a>
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
