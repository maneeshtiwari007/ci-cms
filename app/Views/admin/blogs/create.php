            ...
            <div class="card-body">
                <form action="<?= base_url('admin/blogs/store') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6">
                            <label class="form-label" for="cat_id">Blog Category <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="tags[]" id="tags" class="form-select form-control" multiple>
                                <?php 
                                        $oldTagsRaw = old('tags');
                        ...
                        <div class="col-sm-12">
                            <label class="form-label" for="blog_content">Description</label>
                            <div id="div_editor1"><?= old('blog_content') ?></div>
                            <textarea name="blog_content" id="blog_content"
                                style="display:none;"><?= old('blog_content') ?></textarea>
