        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard/slider') ?>">Slider</a></li>
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/store-slider') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" class="form-control" name="ordering" id="ordering" value="<?= old('ordering', $slider['ordering'] ?? '') ?>" required>
                    </div>
                    ...
                    <a href="<?= base_url('dashboard/slider') ?>" class="btn btn-secondary">Back</a>
                </form>
            </div>
        </div>
    </div>
