                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="<?= base_url('uploads/categories/' . $category['image']) ?>" width="60"
                            ...
                            <td>
                                <a href="<?= base_url('admin/categories/edit/' . $category['id']) ?>"
                                    class="btn btn-sm btn-success btn-icon" title="Edit">
                                    <i class="bi bi-pencil-square"></i>
                                </a>

                                <button type="button" class="btn btn-sm btn-danger btn-icon btn-delete"
                                    data-id="<?= $category['id'] ?>"
